...
$data = 'var playerInstance = jwplayer("ancok-player");playerInstance.setup({sources:'.$file.',preload:"auto",primary:"html5",autostart:"false",playbackRateControls: [0.25, 0.5, 0.75, 1, 2, 3, 4],image:"'.$poster.'",width:"100%",height:"100%",tracks:[{file:"'.$sub.'",label:"English",kind:"captions"}],captions:{color:"#FFFF00",fontSize:15,edgeStyle:"uniform",backgroundOpacity:0,},aboutlink:"onflix",abouttext:"onflix"});playerInstance.on("error", function() { playerInstance = jwplayer("ancok-player"); playerInstance.setup({ width: "100%", height: "100%", autostart: false, sources:[{"file":"https://dl.viperspolite.workers.dev/0:/ezgif.mp4","type":"video/mp4","label":"360p", "default": "true"}],tracks:[{"file":"/","label":"English","kind":"captions","default":"true"}],logo: {file: "https://3.bp.blogspot.com/-ERB5RQQeDyk/YAaki4MnJ1I/AAAAAAAADZE/EzvKbUDFNtsk1g82hosQ5ZtjaGqqXJXqgCK4BGAYYCw/s1600/Copy%2Bof%2BCopy%2Bof%2BCopy%2Bof%2BTHE.png"}, abouttext: "Download Grive-X Player", aboutlink: "https://github.com/karankankaria/GDrive-X", captions: { color: "#FFFF00", fontSize: 14, backgroundOpacity:0,edgeStyle:"uniform" }});jwplayer().onDisplayClick(function() { jwplayer().setFullscreen(true); });});
';
