...
$data = 'var playerInstance = jwplayer("ancok-player");playerInstance.setup({sources:'.$file.',preload:"auto",primary:"html5",autostart:"false",playbackRateControls: [0.25, 0.5, 0.75, 1, 2, 3, 4],image:"'.$poster.'",width:"100%",height:"100%",tracks:[{file:"'.$sub.'",label:"English",kind:"captions"}],captions:{color:"#FFFF00",fontSize:15,edgeStyle:"uniform",backgroundOpacity:0,},aboutlink:"https://github.com/karankankaria/GDrive-X",abouttext:"Download GDrive-X Player",sharing: {},advertising:{client:"vast",admessage:"This is an ad pod. This ad ends in xx seconds.",schedule:{adbreak1:{offset:"pre",tag:""},overlay:{offset:"5",tag: "overlay.xml",type:"nonlinear"},adbreak2:{ offset:"50%",tag:""},overlay:{offset:"5", tag:"overlay.xml",type:"nonlinear"}}}});playerInstance.on("error", function() { playerInstance = jwplayer("ancok-player"); playerInstance.setup({ width: "100%", height: "100%", autostart: false, sources:[{"file":"https://drive.google.com/uc?export=download&id=11ZEZxUB2hn5z-kCYklRvt96bwvJvNJTI","type":"video/mp4","label":"360p", "default": "true"}],tracks:[{"file":"/","label":"English","kind":"captions","default":"true"}],logo: {file: ""}, abouttext: "Download Grive-X Player", aboutlink: "https://github.com/karankankaria/GDrive-X", captions: { color: "#FFFF00", fontSize: 14, backgroundOpacity:0,edgeStyle:"uniform" }});});
';
